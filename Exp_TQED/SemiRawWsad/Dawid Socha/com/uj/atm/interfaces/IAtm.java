...
public interface IAtm {
     ...
     * @return Zwraca true lub false w zależności od tego, czy operacja wypłaty się uda.
     */
     ...
     * Operacja może się nie udać na przykład gdy mamy niewystarczającą ilość środków na koncie.
