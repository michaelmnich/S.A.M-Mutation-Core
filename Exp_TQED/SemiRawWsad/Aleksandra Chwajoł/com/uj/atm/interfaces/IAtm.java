...
public interface IAtm {
     ...
     */
    boolean CheckPinAndLogIn(CreditCard creditCard, String pin);
    /**
     ...
     */
    double AccountStatus(Account account);
    /**
     ...
     */
    boolean ChangePinCard(CreditCard card, String oldPin, String newPin, String newPinConfirm);
    /**
     ...
     */
    boolean DepositFunds(CreditCard card, double amount);
    /**
     ...
     */
    boolean WithdrawFunds(CreditCard card, double amount);
    /**
    ...
    operacja się uda.
     */
    boolean Transfer(CreditCard card, Account accountRecipient, double amount);
}